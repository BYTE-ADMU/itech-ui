<template>
  <Layout>
    ...
    >
      ...
      <!-- COURSES-->
      <div v-if="courses.length === 0" class="grid grid-cols-1 gap-4 mb-12 sm:grid-cols-3 md:grid-cols-4">
      ...
      <div v-else class="grid grid-cols-1 gap-4 mb-12 sm:grid-cols-3 md:grid-cols-4">
        <div class="w-full py-2">
          <h2 class="mx-auto mb-3 text-xl lg:text-4xl font-neuemachina">
            Courses ✨
          </h2>
      ...
      <div v-if="articles.length === 0" class="grid grid-cols-1 gap-4 md:grid-cols-4">
