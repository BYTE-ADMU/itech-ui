    ...
    <div class="lg:px-32 md:px-24 sm:px-20 px-12 sm:py-20 py-10">
      ...
      <div class="w-full mt-12 sm:flex">
        <div class="w-full sm:w-3/12">
          <h2 class="p-2 mx-auto text-2xl lg:text-4xl font-neuemachina" v-if="!search">
            Suggested Courses ✨
          </h2>
          <h2 class="p-2 mx-auto text-2xl lg:text-4xl font-neuemachina" v-else>
            Related Courses ✨
          </h2>
      ...
      <!-- suggested articles -->
      <h2 class="py-6 text-2xl lg:text-4xl font-neuemachina" v-if="!search">Suggested Articles ✨</h2>
      <h2 class="py-6 text-2xl lg:text-4xl font-neuemachina" v-else>Related Articles ✨</h2>
