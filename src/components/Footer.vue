...
<footer class="bg-hacker-primary bottom-0 px-64 text-white">
  <div class="pt-10 pb-6">
    <div class="flex flex-wrap">
      ...
      <div class="w-full md:w-1/5 text-center md:text-left">
        <h5 class="uppercase mb-6 font-bold">The 3Hs
          <hr class="w-10 mt-3" />
        </h5>
        <ul class="mb-4">
          <li class="mt-2">
      ...
      <div class="w-full md:w-1/5 text-center md:text-left">
        <h5 class="uppercase mb-6 font-bold">Resources
          <hr class="w-10 mt-3" />
        </h5>
        <ul class="mb-4">
          <li class="mt-2">
          ...
          <li class="mt-2">
            <a href="#" class="hover:underline  ">Open Source</a>
          </li>
        </ul>
      </div>
      <div class="w-full md:w-1/5 text-center md:text-left">
        <h5 class="uppercase mb-6 font-bold">Contact
          <hr class="w-10 mt-3" />
        </h5>
        <ul class="mb-4">
          <li class="mt-2">
            <a href="#" class="hover:underline  ">Reader Services</a>
          </li>
          <li class="mt-2">
            <a href="#" class="hover:underline  ">Careers</a>
          </li>
          <li class="mt-2">
            <a href="#" class="hover:underline  ">Connect with Us</a>
          </li>
        </ul>
      </div>
      <div class="w-full md:w-1/5 text-center md:text-left">
        <h5 class="uppercase mb-6 font-bold">Press
          <hr class="w-10 mt-3" />
        </h5>
        <ul class="mb-4">
          <li class="mt-2">
            <a href="#" class="hover:underline  ">Newsletters</a>
          </li>
        </ul>
      </div>
    </div>
    <div class="mt-6 flex justify-between items-center border-t">
      <img :src="require('@/assets/img/logo-withWhiteText.svg')" class="w-32 py-6" />
      <p class="text-white text-sm font-light tracking-wide">
        © 2020 ITECH. All Rights Reserved.
      </p>
    </div>
  </div>
</footer>
